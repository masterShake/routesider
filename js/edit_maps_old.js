...
(function(){
	...
	// - 	
	ma.prototype.typeOpacity = function(){
	...
	//   value to 0
	ma.prototype.blurOpacity = function(){
		if(this.value === "")
			this.value = "0";
	}
	...
	window.init =  function(){
	    ...
	    mapApp.colorWheelBtns = document.getElementsByClassName("color-wheel")[0]
	   	...
	   	document.getElementById("polygon-opacity-stroke-input")
	   		.addEventListener("keyup", mapApp.typeOpacity, false);
	   	document.getElementById("polygon-opacity-fill-input")
	   		.addEventListener("keyup", mapApp.typeOpacity, false);
	   	document.getElementById("polygon-opacity-stroke-input")
	   		.addEventListener("blur", mapApp.blurOpacity, false);
	   	document.getElementById("polygon-opacity-fill-input")
	   		.addEventListener("blur", mapApp.blurOpacity, false);
